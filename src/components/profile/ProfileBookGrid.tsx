        ...
        return (
          <li key={b.id}>
            <Link
              ...
              title={b.title}
              className="group flex h-full flex-col gap-2.5 rounded-2xl border border-border/70 bg-card p-2.5 outline-none transition hover:-translate-y-0.5 hover:border-border hover:shadow-[var(--shadow-soft)] focus-visible:ring-2 focus-visible:ring-sky-400/70 sm:p-3"
            >
              ...
              <div className="flex min-h-[42px] flex-col gap-0.5 px-0.5">
